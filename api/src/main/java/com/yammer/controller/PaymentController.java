...
public class PaymentController {
    ...
    /**
     * Line-level settle (full or partial, with order-line splitting). This is the only
     * payment-creation path: it settles order lines and fiscalizes via the durable outbox.
     */
    @PostMapping("/lines")
